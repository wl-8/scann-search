				...
				<a-row :gutter="16">
					<a-col :span="12">
						<a-form-item label="索引类型">
							<a-select v-model:value="state.indexType" class="control-select">
					...
					<a-col :span="12">
						<a-form-item label="距离度量">
							<a-select v-model:value="state.metric" class="control-select">
					...
					<a-col :span="12">
						<a-form-item label="过滤：细胞类型" name="filters.cell_type">
							<a-input v-model:value="state.filters.cell_type" class="control-input" placeholder="例如: T-cell" />
						</a-form-item>
					</a-col>
				</a-row>
			</div>
