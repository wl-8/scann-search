...
var __VLS_40;
if (__VLS_ctx.auth.isResearcher || __VLS_ctx.auth.isAdmin) {
...
(__VLS_ctx.auth.user?.username?.charAt(0)?.toUpperCase() || '?');
__VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
