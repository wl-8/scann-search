...
if (__VLS_ctx.loading) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
    (Number(__VLS_ctx.lastElapsed).toFixed(2));
...
// @ts-ignore
const __VLS_40 = __VLS_asFunctionalComponent(SearchForm, new SearchForm({
    ...{ 'onSubmit': {} },
    modelValue: (__VLS_ctx.formData),
    obsStats: (__VLS_ctx.obsStats),
}));
...
{
    const { expandedRowRender: __VLS_thisSlot } = __VLS_58.slots;
    const [{ record }] = __VLS_getSlotParams(__VLS_thisSlot);
    const __VLS_59 = {}.ADescriptions;
